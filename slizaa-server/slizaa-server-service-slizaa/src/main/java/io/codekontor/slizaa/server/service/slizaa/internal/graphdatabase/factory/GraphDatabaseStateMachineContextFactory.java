...
@Component("GraphDatabaseStateMachineContextFactory")
public class GraphDatabaseStateMachineContextFactory implements IGraphDatabaseStateMachineContextFactory {
  ...
  public IGraphDatabaseStateMachineContext createGraphDatabaseStateMachineContext(String id, File databaseDirectory,
    ...
    return new GraphDatabaseStateMachineContext(id, databaseDirectory, port, _slizaaService);
  }
}
